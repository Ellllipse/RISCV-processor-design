...
VL_INLINE_OPT void Vtestbench::_sequent__TOP__1(Vtestbench__Syms* __restrict vlSymsp) {
    ...
    if (((IData)(vlTOPp->testbench__DOT__dut__DOT__isPCload) 
        ...
        vlTOPp->testbench__DOT__dut__DOT__load_freeze = 1U;
    } else {
        if (vlTOPp->testbench__DOT__dut__DOT__load_freeze) {
            vlTOPp->testbench__DOT__dut__DOT__load_freeze = 0U;
        }
    }
    ...
    vlTOPp->testbench__DOT__dut__DOT__imm_i_sext_q 
        = VL_EXTENDS_II(32,12, (0xfffU & (vlTOPp->testbench__DOT__imem_data 
                                          >> 0x14U)));
    if (vlTOPp->testbench__DOT__dut__DOT__Bsrc) {
        vlTOPp->testbench__DOT__dut__DOT__rs2_value_q 
            = vlTOPp->testbench__DOT__dut__DOT__next_rd;
        if ((3U == (0x7fU & vlTOPp->testbench__DOT__dut__DOT__insn_q))) {
            vlTOPp->testbench__DOT__dut__DOT__rs2_value_q 
        ...
        vlTOPp->testbench__DOT__dut__DOT__rs2_value_q 
            = ((0U != (0x1fU & (vlTOPp->testbench__DOT__imem_data 
                                >> 0x14U))) ? vlTOPp->testbench__DOT__dut__DOT__regfile
               [(0x1fU & (vlTOPp->testbench__DOT__imem_data 
                          >> 0x14U))] : 0U);
    }
    if (vlTOPp->testbench__DOT__dut__DOT__Asrc) {
        ...
        vlTOPp->testbench__DOT__dut__DOT__rs1_value_q 
            = ((0U != (0x1fU & (vlTOPp->testbench__DOT__imem_data 
                                >> 0xfU))) ? vlTOPp->testbench__DOT__dut__DOT__regfile
               [(0x1fU & (vlTOPp->testbench__DOT__imem_data 
                          >> 0xfU))] : 0U);
    }
    if ((1U & (~ ((((IData)(vlTOPp->testbench__DOT__dut__DOT__stall) 
                    | (IData)(vlTOPp->testbench__DOT__dut__DOT__kill)) 
                   & (~ (IData)(vlTOPp->reset))) & 
    ...
    vlTOPp->testbench__DOT__dut__DOT__insn_q = (((((IData)(vlTOPp->testbench__DOT__dut__DOT__stall) 
                                                   | (IData)(vlTOPp->testbench__DOT__dut__DOT__kill)) 
                                                  & (~ (IData)(vlTOPp->reset))) 
                                                 & (~ (IData)(vlTOPp->testbench__DOT__dut__DOT__reset_q)))
                                                 ? 0x13U
